            ...
            <div class="col-12 col-sm-11 col-md-10 col-lg-8">
                <div class="card rgba-grey-slight z-depth-2">
                    <div class="card-body p-2">
                        <form method="post" action="{{url('storePaciente')}}">
                        @csrf
                        <div class="card z-depth-2">
                            <div class="col-12 px-3 py-1">
                                <div class="row align-items-center card-header text-white bg-primary py-2">
                                    <div class="col-md-12 col-lg-6 h3 m-0 p-0 ta-cl">
                                        <i class="fa fa-user-plus text-warning ml-2"></i>
                                ...
                                <div class="row">
                                    <div class="col-4 mb-4">
                                        <div class="mb-2">
                                            ...
                                            <input maxlength="64" type="text" name="nombre" placeholder="Nombre" id="nombre" oninput="this.value=this.value.slice(0,64)" class="form-control required" value="" data-placement="top">
                                        </div>
                                    </div>
                                    <div class="col-4 mb-4">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" id="datepicker" name="nfecha" placeholder="dd/mm/aaaa" class="form-control required">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 mb-4">
                                        <div class="mb-2">
                                            ...
                                            <input maxlength="3" type="number" name="peso" placeholder="Peso" id="peso" oninput="this.value=this.value.slice(0,3)" class="form-control required peso data-placement="top">
                                        </div>
                                    </div>
                                    <div class="col-4 mb-4">
                                        <div class="mb-2">
                                            ...
                                            <input type="number" name="estatura" placeholder="Estatura" id="estatura" class="form-control required estatura text-muted" value="" data-placement="top">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 modal-footer justify-content-center mb-3">
                                <button id="onclick" class="btn btn-primary">Guardar<i class="fa fa-paper-plane ml-1"></i></button>
                            </div>
                        </div>
                        </form>
                    </div>
